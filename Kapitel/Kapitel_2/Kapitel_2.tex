...
\begin{itemize}
    ...
    \item \fatsf{Schleifeninvariante \textmd{(SIV)}:}
          \begin{itemize}
    ...
    \item \fatsf{Effizienz von Algorithmen}:
          \begin{itemize}
    ...
    \item \fatsf{Analyse von MergeSort}
          \begin{itemize}
              ...
              \item Lösen der Rekursionsgleichung mithilfe eines Rekursionsbaums
                    \begin{itemize}
                        \item[] \includegraphics[width=9cm]{pictures/merge_sort_equation/merge_sort_equation}
