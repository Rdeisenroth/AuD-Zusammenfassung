...
\begin{itemize}
    \item \fatsf{Komplexität:}\index{Komplexität}
          \begin{itemize}
    ...
    \item \fatsf{Asymptotik:}\index{Asymptotik}
          \begin{itemize}
    ...
    \item \fatsf{Asymptotische Komplexität:}\index{Asymptotische Komplexität}
          \begin{itemize}
    ...
    \item \fatsf{Asymptotische Notation:}\index{Asymptotische Notation}
          \begin{itemize}
...
\begin{itemize}
    \item \textbf{$\Theta$-Notation}\index{$\Theta$-Notation}
          \begin{itemize}
    ...
    \item \textbf{$\mathcal{O}$-Notation}\index{$\mathcal{O}$-Notation}
          \begin{itemize}
    ...
    \item \textbf{$\Omega$-Notation}\index{$\Omega$-Notation}
          \begin{itemize}
          ...
          \end{itemize}
          \clearpage
    \item \textbf{Komplexitätsklassen}\index{Komplexitätsklassen}
          \begin{itemize}
...
\begin{itemize}
    \item \fatsf{Idee}
          \begin{itemize}
              ...
              \item \texttt{MaxSort}\index{MaxSort}: "wähle größtes Element in Array und tausche es nach vorne"
          \end{itemize}
...
\begin{itemize}
    \item \fatsf{Idee}
          \begin{itemize}
              \item \textit{Pivotelement:}\index{Pivotelement}
                    \begin{itemize}
                        \item[]
    ...
    \item \fatsf{Code}
          \begin{ccode}[autogobble,escapeinside=||]{title={QUICKSORT(A,p,r)}}
              IF p < r    // Überprüfung, ob Teilarray leer ist
                ...
                QUICKSORT(A,q+1,r)
          \end{ccode}
          \index{Partition}\begin{ccode}[autogobble,escapeinside=||]{title={PARTITION(A,p,r)}}
...
\begin{itemize}
    ...
    \item \fatsf{Subsitutionsmethode}\index{Substitutionsmethode}
          \begin{itemize}
    ...
    \item \fatsf{Rekursionsbaum}\index{Rekursionsbaum}
          \begin{itemize}
    ...
    \item \fatsf{Mastertheorem}\index{Mastertheorem}
          \begin{itemize}
              \item \textit{Idee:}
                    \begin{itemize}
                        \item[]
