...
\begin{minipage}{0.5\textwidth}
    \centering\includegraphics[width=\textwidth]{pictures/avlcase1.PNG}
\end{minipage}
\begin{minipage}{0.5\textwidth}
    \centering\includegraphics[width=\textwidth]{pictures/avlcase34.PNG}
\end{minipage}

\begin{minipage}{0.5\textwidth}
    \centering\includegraphics[width=\textwidth]{pictures/avlcase2_1.PNG}
\end{minipage}
\begin{minipage}{0.5\textwidth}
    \centering\includegraphics[width=\textwidth]{pictures/avlcase2_2.PNG}
\end{minipage}
...
\index{Zig-Zag} \includegraphics[width=12cm]{pictures/zigzag.PNG}\\
\index{Zig-Zig} \includegraphics[width=11cm]{pictures/zigzig.PNG}\vspace{1em}\\
\index{Zig} \includegraphics[width=11cm]{pictures/zig.PNG}\\
...
\begin{minipage}[t]{0.43\textwidth}\mbox{}
    \centering
    \includegraphics[width=\textwidth]{pictures/heapDelete.PNG}
