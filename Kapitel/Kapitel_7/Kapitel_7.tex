    ...
    \begin{itemize}
        \item \fatsf{Suchbaum - Baum der Möglichkeiten}
            \begin{itemize}
                ...
                \item[] \includegraphics[width=14cm]{pictures/suchbaum.pdf}
            \end{itemize}
        ...
        \item \fatsf{Damenproblem}\index{Damenproblem}
            \begin{itemize}
                ...
                \item[]
                    ...
                    \end{minipage}
                \item[]
                    \begin{ccode}[autogobble]{title={PLACE-QUEENS(Q,r) // Q Array von Damenpositionen, r Index der ersten leeren Zeile}}
                    IF r == n
                        return Q;
                    ELSE
    ...
    \begin{itemize}
        ...
        \item \fatsf{Rucksackproblem}\index{Rucksackproblem}
            \begin{itemize}
                ...
                \item Beispiellösung: Gegenstand 3 + 5 (Wert 73, Größe 70)
                \item Nachbarschaftslösungen: 
                    \begin{itemize}
                        \item Gegenstände 2,3 und 5: Wert 105, Größe 96
                        \item Gegenstände 1,3 und 5: Wert 152, Größe 155 (Gewichtsüberschreitung problematisch)
                        \item Gegenstand 3: Wert 47, Größe 48
                    \end{itemize}
                \item[]
                    \begin{minipage}{0.4\textwidth}
